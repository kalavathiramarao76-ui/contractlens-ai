...
function ToastCard({
  ...
  const variantStyles: Record<ToastVariant, string> = {
    ...
    info: "border-rose-500/20 bg-rose-500/5 text-rose-300",
  };
  ...
  return (
    <div
      ...
      className={`
        ...
        backdrop-blur-xl bg-[var(--color-background)]/80
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          className="shrink-0 text-white/40 hover:text-white/80 transition-colors text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)] rounded"
        >
          &#x2715;
        </button>
      </div>
